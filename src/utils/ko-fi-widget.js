...
var kofiWidgetOverlayFloatingChatBuilder =
	...
	function (config, _utils) {
		...
		function createButtonContainerIframe(iframeId, mainStyleSheetFile) {
			...
			var buttonBody = "<html>" + "<head>" + `<link rel="preconnect" href="https://ko-fi.com/">` + `<link rel="dns-prefetch" href="https://ko-fi.com/">` + `<link rel="preconnect" href="https://storage.ko-fi.com/">` + `<link rel="dns-prefetch" href="https://storage.ko-fi.com/">` + `<link href="${mainStyleSheetFile}" rel="stylesheet" type="text/css" />` + `</head>` + `<body style="margin: 0; position: absolute; bottom: 0;">${htmlBody}</body>` + "</html>";
